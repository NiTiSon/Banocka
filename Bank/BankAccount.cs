...
namespace BankAccountNS
{
	...
	{
		internal const string DebitAmountExceedsBalanceMessage = "Debit amount exceeds balance";
		internal const string DebitAmountLessThanZeroMessage = "Debit amount is less than zero";
